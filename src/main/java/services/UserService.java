...
public class UserService implements IUserDao {
    ...
    public String generateTemporaryPassword() {
        String chars = "fghjnbvcxasdfghjklxcvbnm12345678967890";
    ...
    try {
        String username = "n.aboubuchr8224@uca.ac.ma"; 
        String password = "xdst rijl dpzc nldv";  // Remplacez par le mot de passe généré
